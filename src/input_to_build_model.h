...
std::string prob_name = "Scalability_test_all_jet_g100x100x3_r1k";
...
int32_t i_term = (int)(0.8*10);    // verify if within grid
int32_t j_term = (int)(0.8*10);    // verify if within grid
// int32_t i_term = 50;
// int32_t j_term = 90;
